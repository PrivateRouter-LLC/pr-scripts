...
PACKAGE_LIST="luci-proto-modemmanager modemmanager v2raya wireguard-tools openvpn-openssl git git-http jq curl wget htop resize2fs debootstrap usbmuxd usbutils ttyd fail2ban samba4-server speedtest-netperf mwan3 luci-ssl luci-app-statistics luci-mod-dashboard luci-app-vnstat luci-app-openvpn luci-app-wireguard adblock kmod-rt2800-usb kmod-lib80211 kmod-rtl8192cu kmod-usb-ohci kmod-usb-uhci luci-compat luci-lib-ipkg kmod-fs-exfat kmod-usb-net-rndis luci-mod-dashboard luci-app-commands luci-app-vnstat luci-app-statistics luci-app-samba4 kmod-usb-net-cdc-eem kmod-usb-net-cdc-ether kmod-usb-net-cdc-subset kmod-usb-net-cdc-ether kmod-usb-net-ipheth libimobiledevice luci-app-nlbwmon comgt kmod-usb-serial-option kmod-usb-serial-wwan usb-modeswitch kmod-usb-serial-wwan kmod-usb-serial-option kmod-usb-net-cdc-mbim qmi-utils luci-proto-qmi umbim kmod-usb-serial-option kmod-usb-serial-wwan kmod-usb-net-rndis kmod-usb-net-cdc-ether rt2800-usb-firmware"
